// Form status: 0 = save, 1... = edit (mode = contact ID)
var mode = 0;
...
// Create the contact input/edit form
createForm = () => {
    ...
    let phoneText = document.createTextNode("Tel");
    ...
    // DOM requires you to clone the <br> node here because the original <br> node is already used up
...
// Populate table with list of contacts
populateTable = (data) => {
    ...
    const phoneText = document.createTextNode("Tel");
